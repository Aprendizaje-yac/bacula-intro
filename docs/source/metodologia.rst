...
Se realizará un relevamiento para conocer, visualizar los distintos casos a realizar 
respaldos *(Ej: cantidad de archivos, tamaño de archivos, maquinas virtuales, servidores fisicos etc)*.
